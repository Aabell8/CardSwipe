package com.austinabell8.cardswipe;
...
import com.austinabell8.cardswipe.Utility.Deck;
import com.austinabell8.cardswipe.Utility.SwipeCallback;
...
public class SwipeDeck extends FrameLayout {
    ...
    public SwipeDeck(final Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        MAX_CARDS = a.getInt(R.styleable.CardSwipe_max_visible, 3);
    ...
    public void setAdapter(final Adapter adapter) {
        ...
        observer = new DataSetObserver() {
            ...
            public void onChanged() {
                ...
                if (deckSize < MAX_CARDS) {
                    for (int i = deckSize; i < MAX_CARDS; ++i) {
                        addNextView();
                    }
                }
    ...
    public void swipeTopCardBottom(int duration) {
        if (deck.size() > 0) {
            deck.get(0).swipeCardBottom(duration);
            if (callback != null) {
                callback.cardSwipedBottom(deck.get(0).getId());
            }
            deck.removeFront();
        }
    }
    ...
    public interface SwipeDeckCallback {
        ...
        void cardSwipedBottom(long itemId);
    ...
    private class CardContainerCallback implements SwipeCallback {
        ...
        public void cardSwipedBottom(View card) {
            ...
            deck.removeFront();
            if (callback != null) {
                callback.cardSwipedBottom(viewId);
            }
        }
